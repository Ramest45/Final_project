...
urlpatterns = [
    ...
    path('upload_comp',upload_comp,name="upload_comp"),
    ...
    path('deleteAdminfeed/<int:id>',deleteAdminfeed,name="deleteAdminfeed"),
    path('deleteAdmincomp/<int:id>',deleteAdmincomp,name="deleteAdmincomp"),
